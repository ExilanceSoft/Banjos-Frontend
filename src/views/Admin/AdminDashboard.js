...
const AdminDashboard = () => {
  ...
  useEffect(() => {
    ...
    const intervalId = setInterval(() => {
      ...
      // For demo purposes, we'll just rotate the avatars to show the refresh working
      setUsers(prevUsers => {
        const rotatedUsers = [...prevUsers];
        const firstUser = rotatedUsers.shift();
        return [...rotatedUsers, firstUser];
      });
    }, refreshInterval);
        ...
        <CCol xs={12} md={4}>
          <CCard className="mb-4">
            <CCardBody>
              ...
              <small className="text-muted">Page auto-refreshes every 30 seconds</small>
            </CCardBody>
          </CCard>
        </CCol>
      </CRow>
